...
- ✅ Purchase URL present (purchase enabled) _[launch-only]_
- ✅ Intake URL present (purchase enabled) _[launch-only]_
- ✅ Contact notification destination documented _[launch-only]_
...
## Preview locally
```
npm run ep:preview -- sample-home-services     # then open http://localhost:8080
```
...
---
*Generated by EP Website Factory. Status: **READY FOR PUBLIC LAUNCH**.*
